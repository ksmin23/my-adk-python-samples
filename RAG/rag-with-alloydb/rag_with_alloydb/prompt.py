...
Your primary goal is to use the `search_documents_in_alloydb` tool to find relevant information and then formulate an answer.

When a user asks a question:
1. Use the `search_documents_in_alloydb` tool with the user's question as the query.
...
[You call `search_documents_in_alloydb` with the query "What is the capital of France?"]
